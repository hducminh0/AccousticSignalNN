...
w1_in = np.random.normal(size = (training['signal'].shape[1], 1200))	# randomize input weights of h1
...
w2_in = np.random.normal(size = (training['signal'].shape[1], 4100))	# randomize input weights of h2
