...
w0_in = np.random.normal(size = (training['signal'].shape[1], 2000))	# randomize input weights of h0
...
w1_in = np.random.normal(size = (training['signal'].shape[1], 3000))	# randomize input weights of h1
...
w2_in = np.random.normal(size = (training['signal'].shape[1], 5000))	# randomize input weights of h2
